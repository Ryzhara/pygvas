...
from tests.common.utils import (
    ASSERT_FAILED_PATH, COMPONENT8_PATH, DELEGATE_PATH, ENUM_ARRAY_PATH,
    FEATURES_01_PATH, OPTIONS_PATH, PACKAGE_VERSION_524_PATH,
    PALWORLD_ZLIB_PATH, PALWORLD_ZLIB_TWICE_PATH, PROFILE_0_PATH,
    REGRESSION_01_PATH, RO_64BIT_FAV_PATH, SAVESLOT_03_PATH,
    SLOT1_PATH, SLOT2_PATH, SLOT3_PATH, TEXT_PROPERTY_NOARRAY,
    TRANSFORM_PATH, VECTOR2D_PATH,
    test_gvas_file, test_gvas_file_with_hints
)
...
from tests.gvas_tests.saveslot3 import expected as saveslot3_expected, hints as saveslot3_hints
...
class TestGvas(unittest.TestCase):
    ...
    def test_features_01(self):
        ...
        test_gvas_file_with_hints(FEATURES_01_PATH, GameVersion.DEFAULT, features_hints())
    ...
    def test_palworld_zlib_twice(self):
        ...
        test_gvas_file_with_hints(PALWORLD_ZLIB_TWICE_PATH, GameVersion.PALWORLD, palworld_hints())
    ...
    def test_saveslot03(self):
        ...
        file = test_gvas_file_with_hints(SAVESLOT_03_PATH, GameVersion.DEFAULT, saveslot3_hints())
