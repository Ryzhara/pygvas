...
class TestStructProperty(unittest.TestCase):
    ...
    def test_struct_property_with_values(self):
        ...
        self.assertEqual(
            struct_prop.value.properties["StringValue"].value.value, "Hello, world!"
        )
    ...
    def test_struct_property_roundtrip(self):
        ...
        self.assertEqual(
            deserialized_prop.value.properties["BoolValue"].value.value, True
        )
        self.assertEqual(
            deserialized_prop.value.properties["StringValue"].value.value,
            "Hello, world!",
        )
    ...
    def test_nested_struct_property(self):
        ...
        self.assertEqual(
            deserialized_struct.value.properties["Name"].value.value, "Test"
        )
