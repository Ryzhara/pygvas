...
from gvas.properties.int_property import (
    BoolProperty, ByteProperty, BytePropertyValue, FloatProperty,
    Int8Property, Int16Property, Int32Property, Int64Property,
...
class TestProperty(unittest.TestCase):
    ...
    def test_property_roundtrip(self, property_obj: PropertyTrait, property_type: str):
        ...
        self.assertEqual(imported_type, property_type, f"Expected {property_type}, got {imported_type}")
    ...
    def test_int_properties(self):
        ...
        self.test_property_roundtrip(UInt64Property(value=10000000000000000000), "UInt64Property")
