...
from gvas.types import HashableIndexMap
...
class TestGvasFile(unittest.TestCase):
    ...
    def test_create_file(self):
        ...
        self.assertEqual(loaded_file.properties["StringProperty"].value.value, "Hello, world!")
