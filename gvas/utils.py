...
def read_atomic_data(
    stream: BinaryIO, format_str: str, width: int, assert_value=None
) -> int:
    ...
    if assert_value is not None:
        if value != assert_value:
            raise AssertionError(
                f"Expected value {value} != {assert_value} at {position=}"
            )
    return value


# ============= NUMERIC READS/WRITES ========================
def read_int8(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<b", 1, assert_value)
...
def read_uint8(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<B", 1, assert_value)
...
def read_bool(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "?", 1, assert_value)
...
def read_int16(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<h", 2, assert_value)
...
def read_uint16(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<H", 2, assert_value)
...
def read_int32(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<i", 4, assert_value)
...
def read_uint32(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<I", 4, assert_value)
...
def read_int64(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<q", 8, assert_value)
...
def read_uint64(stream: BinaryIO, assert_value=None) -> int:
    return read_atomic_data(stream, "<Q", 8, assert_value)
...
def read_float(stream: BinaryIO, assert_value=None) -> float:
    return read_atomic_data(stream, "<f", 4, assert_value)
...
def read_double(stream: BinaryIO, assert_value=None) -> float:
    return read_atomic_data(stream, "<d", 8, assert_value)
